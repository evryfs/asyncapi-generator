package com.tietoevry.banking.asyncapi.generator.core.generator.avro.complexorder

import com.tietoevry.banking.asyncapi.generator.core.generator.AbstractAvroGeneratorClass
...
class AvroComplexOrderTest : AbstractAvroGeneratorClass() {
    ...
    fun `should generate complex order schema`() {
        val content = generateAvro(
            ...
            packageName = "com.tietoevry.banking.asyncapi.generator.core.generated.avro",
    ...
    fun `should generate referenced types as named types`() {
        val content = generateAvro(
            yaml = File("src/test/resources/generator/asyncapi_complex_order_payload_type.yaml"),
            packageName = "com.tietoevry.banking.avro",
            schema = "ComplexOrderPayloadType.avsc"
        )

        assertTrue(content.isNotEmpty(), "Generated content empty")
        assertTrue(content.contains("\"namespace\": \"com.tietoevry.banking.avro\""))
        assertTrue(
            content.contains("\"type\": \"com.tietoevry.banking.avro.CustomerWithContacts\""),
