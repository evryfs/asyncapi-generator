package com.tietoevry.banking.asyncapi.generator.core.generator.java.kafka
...
class GenerateJavaSpringKafkaClientTest : AbstractJavaGeneratorClass() {
    ...
    fun `should generate full spring kafka ecosystem for Java`() {
        ...
        val modelPackage = "com.tietoevry.banking.ace.userservice.v1.model"
        val clientPackage = "com.tietoevry.banking.ace.userservice.v1.client"
