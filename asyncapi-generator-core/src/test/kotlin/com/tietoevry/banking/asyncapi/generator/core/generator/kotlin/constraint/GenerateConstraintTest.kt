package com.tietoevry.banking.asyncapi.generator.core.generator.kotlin.constraint
...
class GenerateConstraintTest : AbstractKotlinGeneratorClass() {
    ...
    fun generate_asyncapi_string_constraints_type_StringConstraintsType_dataClass() {
        val generated = generateElement(
            ...
            modelPackage = "com.tietoevry.banking.asyncapi.generator.core.model.generated.constraint",
        )
