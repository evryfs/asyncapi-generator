package com.tietoevry.banking.asyncapi.generator.core.generator.kotlin.readwrite
...
class GenerateReadWriteOnlyTest : AbstractKotlinGeneratorClass() {
    ...
    fun generate_data_class_with_readOnly_writeOnly_fields() {
        val generated = generateElement(
            ...
            modelPackage = "com.tietoevry.banking.asyncapi.generator.core.model.generated.access",
        )
