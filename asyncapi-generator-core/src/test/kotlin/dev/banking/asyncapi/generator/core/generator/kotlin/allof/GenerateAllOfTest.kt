package dev.banking.asyncapi.generator.core.generator.kotlin.allof
...
class GenerateAllOfTest : AbstractKotlinGeneratorClass() {
    ...
    fun generate_asyncapi_allOf_composition_BaseAccount_dataClass() {
        val generated = generateElement(
            ...
            modelPackage = "dev.banking.asyncapi.generator.core.model.generated.allof.composition",
        )
    ...
    fun generate_asyncapi_allOf_overrides_Dog_dataClass() {
        val generated = generateElement(
            ...
            generated = "Dog.kt",
            modelPackage = "dev.banking.asyncapi.generator.core.model.generated.allof.overrides",
        )
        val dataClass = extractElement(generated)
        val expected = """
           data class Dog(
    ...
    fun generate_asyncapi_allOf_constraint_intersection_ExtendedRange_dataClass() {
        val generated = generateElement(
            ...
            modelPackage = "dev.banking.asyncapi.generator.core.model.generated.allof.constraint",
        )
        val dataClass = extractElement(generated)
        val expected = """
