 ...
 *
 * <p>Example implementation for forwarding an already serialized record value:
 *
 * <p>Contract-defined headers still require application-owned encoding before
 * they are added to the {@code ProducerRecord} headers.
 *
 * <pre>{@code
 * @Component
 * public final class MyAccountUpdatedProducerImpl implements MyAccountUpdatedProducer {
 *     private final String topicAddress;
 *     private final KafkaTemplate<MyAccountKey, String> kafkaTemplate;
 *
 *     public MyAccountUpdatedProducerImpl(
 *             @Value(MyAccountUpdatedProducer.MY_ACCOUNT_UPDATED_TOPIC_ADDRESS) String topicAddress,
 *             KafkaTemplate<MyAccountKey, String> kafkaTemplate) {
