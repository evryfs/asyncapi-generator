...
import com.tietoevry.banking.asyncapi.generator.core.generator.analyzer.ChannelAnalyzer
import com.tietoevry.banking.asyncapi.generator.core.generator.kotlin.KotlinGenerator
import com.tietoevry.banking.asyncapi.generator.core.generator.analyzer.SchemaAnalyzer
import com.tietoevry.banking.asyncapi.generator.core.generator.avro.AvroGenerator
...
import com.tietoevry.banking.asyncapi.generator.core.generator.java.JavaGenerator
import com.tietoevry.banking.asyncapi.generator.core.generator.java.factory.JavaGeneratorModelFactory
import com.tietoevry.banking.asyncapi.generator.core.generator.java.kafka.spring.JavaSpringKafkaGenerator
import com.tietoevry.banking.asyncapi.generator.core.generator.kotlin.factory.KotlinGeneratorModelFactory
import com.tietoevry.banking.asyncapi.generator.core.generator.kotlin.kafka.spring.KotlinSpringKafkaGenerator
import com.tietoevry.banking.asyncapi.generator.core.generator.loader.AsyncApiSchemaLoader
import com.tietoevry.banking.asyncapi.generator.core.generator.normalizer.SchemaNormalizer
...
class AsyncApiGenerator {
    ...
    fun generate(
        ...
        val asyncApiContext = com.tietoevry.banking.asyncapi.generator.core.context.AsyncApiContext()
