...
| External Kafka message key schema | [Source](https://github.com/evryfs/asyncapi-generator/blob/main/asyncapi-generator-core/src/test/resources/generator/spring-kafka/single-message.yaml) | [Output](https://github.com/evryfs/asyncapi-generator/blob/main/asyncapi-generator-core/src/test/resources/approvals/bundler/external-kafka-key-schema.approved.yaml) | An external schema used by `bindings.kafka.key` is serialized into the binding so the bundled document does not depend on the source schema file. |
| External-tool interoperability contract | [Source](https://github.com/evryfs/asyncapi-generator/blob/main/asyncapi-generator-core/src/test/resources/bundler/approval/interoperability/main.yaml) | [Output](https://github.com/evryfs/asyncapi-generator/blob/main/asyncapi-generator-core/src/test/resources/approvals/bundler/interoperability-contract.approved.yaml) | A representative Kafka contract combines external servers, messages, key schemas, nested reusable objects, operation topology, and recursive schemas in one standalone document. |
